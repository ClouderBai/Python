...
try:
    ...
    # BucketName = "lly-cn-ibu-cmds-ods-prd-private"
    ...
    glue_postgre_table_i_ads_cust_algnmnt = "cmds_qa_cmdsprd_cmd_owner_i_ads_cust_algnmnt"
    glue_postgre_table_i_ads_cust_algnmnt_tier_vw = "cmds_qa_cmdsprd_cmd_owner_i_ads_cust_algnmnt_tier_vw"
    ...
    Lambda_function_name = 'cmds-prd-s3-odsTds'
    ...
    applymapping11 = ApplyMapping.apply(frame=datasource10,
                                        mappings=[
                                            ...
                                            ("cust_algnmnt_strt_dt", "timestamp", "cust_algnmnt_strt_dt", "timestamp"),
                                            ("cust_algnmnt_end_dt", "timestamp", "cust_algnmnt_end_dt", "timestamp"),
                                            ("cust_typ_cd", "string", "cust_typ_cd", "string"),
                                            ("src_external_id", "long", "src_external_id", "string"),
                                            ...
                                            ("ods_lst_updt_dt", "timestamp", "ods_lst_updt_dt", "timestamp"),
    ...
    ## @type: ResolveChoice
    ## @args: [choice = "MATCH_CATALOG", database = glue_catalog_database_name, table_name = "cmds_qa_cmdsprd_cmd_owner_i_ads_cust_algnmnt", transformation_ctx = "resolvechoice13"]
    ...
    resolvechoice13 = ResolveChoice.apply(frame=selectfields12, choice="MATCH_CATALOG",
                                          ...
                                          table_name="cmds_qa_cmdsprd_cmd_owner_i_ads_cust_algnmnt",
    ...
    i_ads_cust_algnmnt_temp_df = i_ads_cust_algnmnt_df.withColumn("cust_algnmnt_strt_dt", F.unix_timestamp("cust_algnmnt_strt_dt", 'MM/dd/yyyy HH:mm:ss').cast("timestamp")) \
        .withColumn("cust_algnmnt_end_dt", F.unix_timestamp("cust_algnmnt_end_dt", 'MM/dd/yyyy HH:mm:ss').cast("timestamp")) \
    ...
    conn = glueContext.extract_jdbc_conf('conn-cmds-prd-rds-postgre-writer')
    # print("conn:",conn)
    url = conn['url']
    # print("url",url)
    USERNAME = conn['user']
    ...
    applymapping1 = ApplyMapping.apply(frame=datasource0, mappings=[("actl_tier", "long", "actl_tier", "string"),
                                                                    ...
                                                                    ("recmnd_tier", "long", "recmnd_tier", "string"), (
                                                                        ...
                                                                        "src_algnmnt_typ_cd", "string"), (
                                                                        "ods_ld_dt", "timestamp", "ods_ld_dt",
                                                                        "timestamp"),
                                                                    ("ods_lst_updt_dt", "timestamp", "ods_lst_updt_dt",
                                                                     "timestamp"),
                                                                    ("src_sys_cd", "string", "src_sys_cd", "string"),
                                                                    ("ods_ld_usr", "string", "ods_ld_usr", "string"), (
                                                                        "ods_lst_updt_usr", "string",
                                                                        "ods_lst_udpt_usr",
